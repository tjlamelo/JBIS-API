...
namespace App\Core\Domain\Catalog\DTOs\ContractType;

readonly class ContractTypeDto
{
    /**
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            color_code: isset($data['color_code']) && $data['color_code'] !== '' ? (string) $data['color_code'] : null,
        );
    }
