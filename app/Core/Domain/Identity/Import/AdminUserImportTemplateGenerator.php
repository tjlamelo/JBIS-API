...
final class AdminUserImportTemplateGenerator
{
    ...
    private function addInstructionsSheet(Spreadsheet $spreadsheet): void
    {
        ...
        $lines = [
            ...
            ['phone_number1', 'Un ou plusieurs numéros (séparateur / ; | ,). Ex. 6xxxxxxx/6yyyyyyy → phone1 + phone2/3.'],
            ['name', 'Optionnel. Si vide, composé automatiquement avec first_name + last_name.'],
            ['Email déjà existant', 'Signalé (skip) : à l’import confirmé, la ligne est ignorée sans bloquer le reste.'],
            ['Valeurs vides', 'Lignes vides / espaces / lignes commençant par # : ignorées.'],
            ['Doublons fichier', 'Email ou téléphone en double dans le fichier = erreur bloquante.'],
