...
final class ReviewRecruiterOfferSubmissionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'offer_payload.skill_requirements.*.skill_id' => ['required', 'integer', 'exists:skills,id'],
            'offer_payload.skill_requirements.*.level' => ['nullable', 'string', 'max:32'],
            'offer_payload.proposed_skills' => ['sometimes', 'nullable', 'array', 'max:20'],
            'offer_payload.proposed_skills.*.label' => ['required', 'string', 'max:120'],
            'offer_payload.proposed_skills.*.level' => ['nullable', 'string', 'max:32'],
