    ...
    public function toArray(Request $request): array
{
    ...
    return [
        ...
        'description' => $this->getTranslations('description'), // 🟢 Important pour la vue
        'photo' => $this->photo,
     ...
     */
    private function resolveLanguageLevelTranslations(array|null $translations, ?string $fallback): ?array
    {
