    ...
    public function run(): void
    {
        ...
        $skills = array_merge(
            ...
            $this->categorySkills('administration-management', [
                ...
                ['fr' => 'Maîtrise des outils bureautiques (Word, Excel, Outlook)', 'en' => 'Office software proficiency (Word, Excel, Outlook)', 'category' => 'technique'],
            ...
            $this->categorySkills('it-technology', [
                ...
                ['fr' => 'Développement mobile (Swift, Kotlin, Flutter)', 'en' => 'Mobile development (Swift, Kotlin, Flutter)', 'category' => 'technique'],
            ...
            $this->categorySkills('digital-trades-data-cloud-cybersecurity', [
                ...
                ['fr' => 'Automatisation d’infrastructure (IaC - Terraform)', 'en' => 'Infrastructure automation (IaC - Terraform)', 'category' => 'technique'],
            ]),
            $this->categorySkills('artificial-intelligence', [
                ...
                ['fr' => 'Deep Learning (TensorFlow, PyTorch)', 'en' => 'Deep Learning (TensorFlow, PyTorch)', 'category' => 'technique'],
            ...
            $this->categorySkills('sales-distribution', [
                ...
                ['fr' => 'Utilisation d’un CRM (Salesforce, HubSpot)', 'en' => 'CRM usage (Salesforce, HubSpot)', 'category' => 'technique'],
            ...
            $this->categorySkills('design-creative', [
                ...
                ['fr' => 'Design UI/UX et prototypage (Figma)', 'en' => 'UI/UX design and prototyping (Figma)', 'category' => 'technique'],
            ...
            $this->categorySkills('engineering', [
                ['fr' => 'Conception technique et modélisation (CAO)', 'en' => 'Technical design and modelling (CAD)', 'category' => 'technique'],
            ...
            $this->categorySkills('vr-ar-technology', [
                ['fr' => 'Développement 3D temps réel (Unity, Unreal)', 'en' => 'Real-time 3D development (Unity, Unreal)', 'category' => 'technique'],
                ['fr' => 'Modélisation et design immersif', 'en' => 'Immersive design and modelling', 'category' => 'technique'],
                ['fr' => 'Intégration Unity/Unreal Engine', 'en' => 'Unity/Unreal Engine integration', 'category' => 'technique'],
            ...
            $this->categorySkills('business-intelligence-strategic-watch', [
                ...
                ['fr' => 'Outils de BI (Power BI, Tableau)', 'en' => 'BI tools (Power BI, Tableau)', 'category' => 'technique'],
