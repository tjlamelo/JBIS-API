...
class CategorySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $categories = [
            ...
            // === AJOUTS : SECTEURS COMPLÉMENTAIRES ===
            [
                'fr' => 'Sport & Fitness',
                'en' => 'Sports & Fitness',
                'description_fr' => 'Coaching sportif, préparation physique, encadrement d\'activités sportives.',
                'description_en' => 'Sports coaching, physical training, sports activity supervision.',
            ],
            [
                'fr' => 'Pompes funèbres & Cérémonies',
                'en' => 'Funeral & Death Care',
                'description_fr' => 'Organisation de funérailles, thanatopraxie, gestion de cimetières.',
                'description_en' => 'Funeral organization, embalming, cemetery management.',
            ],
            [
                'fr' => 'Mines & Carrières',
                'en' => 'Mining & Quarrying',
                'description_fr' => 'Extraction minière, exploitation de carrières, forage.',
                'description_en' => 'Mining extraction, quarry operation, drilling.',
            ],
            [
                'fr' => 'Pétrole & Gaz',
                'en' => 'Oil & Gas',
                'description_fr' => 'Forage, raffinage, production et maintenance pétrolière et gazière.',
                'description_en' => 'Drilling, refining, oil and gas production and maintenance.',
            ],
            [
                'fr' => 'Chimie & Laboratoire',
                'en' => 'Chemistry & Laboratory',
                'description_fr' => 'Analyse chimique, contrôle qualité, recherche en laboratoire.',
                'description_en' => 'Chemical analysis, quality control, laboratory research.',
            ],
            [
                'fr' => 'Imprimerie & Édition',
                'en' => 'Printing & Publishing',
                'description_fr' => 'Impression, reliure, édition et distribution de publications.',
                'description_en' => 'Printing, bookbinding, publishing and distribution.',
            ],
            [
                'fr' => 'Musique & Arts du spectacle',
                'en' => 'Music & Performing Arts',
                'description_fr' => 'Musique, théâtre, danse, cirque et production de spectacles.',
                'description_en' => 'Music, theatre, dance, circus and live show production.',
            ],
            [
                'fr' => 'Foresterie & Exploitation forestière',
                'en' => 'Forestry & Logging',
                'description_fr' => 'Abattage, exploitation et gestion des forêts.',
                'description_en' => 'Tree felling, forest exploitation and management.',
            ],
            [
                'fr' => 'Commerce international & Douanes',
                'en' => 'International Trade & Customs',
                'description_fr' => 'Import-export, courtage international, opérations douanières.',
                'description_en' => 'Import-export, international brokerage, customs operations.',
            ],
            [
                'fr' => 'Sécurité sanitaire & Inspection alimentaire',
                'en' => 'Food Safety & Inspection',
                'description_fr' => 'Contrôle sanitaire, inspection et audit de sécurité alimentaire.',
                'description_en' => 'Health inspection, food safety auditing and control.',
            ],
            [
                'fr' => 'Services aux animaux',
                'en' => 'Pet & Animal Services',
                'description_fr' => 'Soins, toilettage, garde et vente d\'animaux de compagnie.',
                'description_en' => 'Care, grooming, sitting and sale of pets.',
            ],
            [
                'fr' => 'Investigation privée & Détective',
                'en' => 'Private Investigation & Detective',
                'description_fr' => 'Enquêtes privées, filature, renseignement et lutte contre la fraude.',
                'description_en' => 'Private investigations, surveillance, intelligence and fraud detection.',
            ],
            [
                'fr' => 'Services postaux',
                'en' => 'Postal Services',
                'description_fr' => 'Distribution du courrier, tri postal et gestion de bureaux de poste.',
                'description_en' => 'Mail delivery, postal sorting and post office management.',
            ],
            [
                'fr' => 'Loisirs nautiques',
                'en' => 'Nautical Leisure',
                'description_fr' => 'Activités et services liés à la plaisance et aux loisirs nautiques.',
                'description_en' => 'Activities and services related to boating and water leisure.',
            ],
            [
                'fr' => 'Services à domicile & Petits travaux',
                'en' => 'Domestic Services & Odd Jobs',
                'description_fr' => 'Bricolage, jardinage et petits travaux à domicile.',
                'description_en' => 'Handyman work, gardening and small home jobs.',
            ],
            [
                'fr' => 'Récupération & Ferraille',
                'en' => 'Recycling & Scrap',
                'description_fr' => 'Récupération, démantèlement et négoce de métaux et matériaux recyclables.',
                'description_en' => 'Recovery, dismantling and trading of scrap metal and recyclable materials.',
            ],
            [
                'fr' => 'Services spirituels & Religieux',
                'en' => 'Spiritual & Religious Services',
                'description_fr' => 'Culte, accompagnement spirituel et pratiques religieuses.',
                'description_en' => 'Worship, spiritual guidance and religious practices.',
            ],
            [
                'fr' => 'Cinéma & Production audiovisuelle',
                'en' => 'Cinema & Audiovisual Production',
                'description_fr' => 'Production, réalisation et tournage de films et contenus audiovisuels.',
                'description_en' => 'Production, direction and filming of movies and audiovisual content.',
            ],
            [
                'fr' => 'Jeux vidéo & Esport',
                'en' => 'Gaming & Esports',
                'description_fr' => 'Développement de jeux vidéo, compétition et création de contenu esport.',
                'description_en' => 'Video game development, esports competition and content creation.',
            ],
            [
                'fr' => 'Beauté, Bien-être & Spa',
                'en' => 'Beauty, Wellness & Spa',
                'description_fr' => 'Soins du corps, massages et pratiques de bien-être en institut ou spa.',
                'description_en' => 'Body care, massage and wellness practices in spas and beauty institutes.',
            ],
            [
                'fr' => 'Blanchisserie & Pressing',
                'en' => 'Laundry & Dry Cleaning',
                'description_fr' => 'Nettoyage à sec, blanchisserie industrielle et services de pressing.',
                'description_en' => 'Dry cleaning, industrial laundry and pressing services.',
            ],
            [
                'fr' => 'Distributeurs automatiques',
                'en' => 'Vending Machines',
                'description_fr' => 'Installation, approvisionnement et maintenance de distributeurs automatiques.',
                'description_en' => 'Installation, restocking and maintenance of vending machines.',
            ],
            [
                'fr' => 'Maison intelligente & Domotique',
                'en' => 'Smart Home & Home Automation',
                'description_fr' => 'Installation et programmation de systèmes domotiques et de maison connectée.',
                'description_en' => 'Installation and programming of home automation and smart home systems.',
            ],
            [
                'fr' => 'Recyclage textile & Seconde main',
                'en' => 'Textile Recycling & Second-Hand',
                'description_fr' => 'Collecte, tri et revente de vêtements et textiles d\'occasion.',
                'description_en' => 'Collection, sorting and resale of used clothing and textiles.',
            ],
            [
                'fr' => 'Spatial & Aérospatiale',
                'en' => 'Space & Aerospace',
                'description_fr' => 'Ingénierie spatiale, systèmes satellites et exploration aérospatiale.',
                'description_en' => 'Space engineering, satellite systems and aerospace exploration.',
            ],
            [
                'fr' => 'Photomaton & Photo événementielle',
                'en' => 'Photo Booth & Event Photo',
                'description_fr' => 'Photographie de mariage, d\'événements et exploitation de photomatons.',
                'description_en' => 'Wedding and event photography, and photo booth operation.',
            ],
            [
                'fr' => 'Mobilité urbaine & Micro-mobilité',
                'en' => 'Urban Mobility & Micro-Mobility',
                'description_fr' => 'Maintenance et gestion des trottinettes, vélos en libre-service et stationnement.',
                'description_en' => 'Maintenance and management of e-scooters, bike-sharing and parking.',
            ],
        ];
