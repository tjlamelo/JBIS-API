...
class DocumentTypeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $catalog = [
            ...
            [
                'code' => 'HOST_AGREEMENT',
                'label' => ['fr' => "Convention d'accueil", 'en' => 'Host agreement'],
                'storage_slug' => 'convention-accueil',
                'max_file_size_kb' => 10240,
                'sort_order' => 265,
            ],
            [
                'code' => 'INTERNSHIP_CERTIFICATE',
                'label' => ['fr' => 'Attestation de stage', 'en' => 'Internship certificate'],
                'storage_slug' => 'attestation-stage',
                'max_file_size_kb' => 10240,
                'sort_order' => 270,
            ],
            [
                'code' => 'INTERNSHIP_REPORT',
                'label' => ['fr' => 'Rapport de stage', 'en' => 'Internship report'],
                'storage_slug' => 'rapport-stage',
                'max_file_size_kb' => 10240,
                'sort_order' => 275,
            ],
            [
                'code' => 'INTERNSHIP_EVALUATION',
                'label' => ['fr' => "Fiche d'évaluation de stage", 'en' => 'Internship evaluation'],
                'storage_slug' => 'evaluation-stage',
                'max_file_size_kb' => 10240,
                'sort_order' => 280,
            ],
            [
                'code' => 'APPRENTICESHIP_CONTRACT',
                'label' => ['fr' => "Contrat d'apprentissage", 'en' => 'Apprenticeship contract'],
                'storage_slug' => 'contrat-apprentissage',
                'max_file_size_kb' => 10240,
                'sort_order' => 285,
            ],
            [
            ...
            [
                ...
                'label' => ['fr' => 'Attestation de scolarité', 'en' => 'School certificate'],
                'storage_slug' => 'attestation-scolarite',
                'max_file_size_kb' => 10240,
                'sort_order' => 295,
            ],
            [
                'code' => 'ENROLLMENT_CERTIFICATE',
                'label' => ['fr' => "Attestation d'inscription", 'en' => 'Enrollment certificate'],
                'storage_slug' => 'attestation-inscription',
                'max_file_size_kb' => 10240,
                'sort_order' => 300,
            ],
            [
                'code' => 'STUDENT_CARD',
                'label' => ['fr' => "Carte d'étudiant", 'en' => 'Student card'],
                'storage_slug' => 'carte-etudiant',
                'unique_per_user' => true,
                'requires_expiry_date' => true,
                'requires_document_number' => true,
                'max_file_size_kb' => 5120,
            ...
            [
                ...
                'label' => ['fr' => 'Certificat de langue', 'en' => 'Language certificate'],
                'storage_slug' => 'certificat-langue',
                'requires_expiry_date' => true,
                'max_file_size_kb' => 10240,
                'sort_order' => 310,
            ],
            [
                'code' => 'VOLUNTEER_CERTIFICATE',
                'label' => ['fr' => 'Attestation de bénévolat / volontariat', 'en' => 'Volunteer certificate'],
                'storage_slug' => 'attestation-benevolat',
                'max_file_size_kb' => 10240,
                'sort_order' => 315,
            ],
            [
                'code' => 'JOB_OFFER_LETTER',
                'label' => ['fr' => "Lettre / promesse d'embauche", 'en' => 'Job offer letter'],
                'storage_slug' => 'lettre-embauche',
                'max_file_size_kb' => 10240,
                'sort_order' => 320,
            ],
